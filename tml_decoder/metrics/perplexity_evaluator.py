...
def evaluate_perplexity(reference_texts: List[str], generated_texts: List[str], model_name: str = 'gpt2', device: str = 'cuda' if torch.cuda.is_available() else 'cpu', batch_size: int = 8) -> Tuple[List[float], List[float]]:
