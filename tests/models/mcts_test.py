...
class TestMCTSModel:
    ...
    def test_expand_functionality_real_node(self, mcts_model, mocker):
        ...
        mocked_states = ["These documents describe something interesting.", "These documents describe something boring."]
        ...
        initial_node = Node(initial_state, mcts_model.encoder, mcts_model.generator, mcts_model.target_embedding, None)
